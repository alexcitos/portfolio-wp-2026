 ...
 * sobre mí y contacto. El texto es de ejemplo; el contenido real y el
 * diseño se ajustarán más adelante.
 *
 * @package Portafolio
 */
...
<main id="contenido" class="sitio-contenido portada">
	...
	<section class="portada-hero" aria-labelledby="hero-titulo">
		...
		<p class="hero-tagline">
			Desarrollo WordPress a medida, marketing digital e infraestructura IT
